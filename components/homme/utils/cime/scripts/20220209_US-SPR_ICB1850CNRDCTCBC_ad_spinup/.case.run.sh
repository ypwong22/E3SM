...
#PBS  -N run.20220209_US-SPR_ICB1850CNRDCTCBC_ad_spinup
#PBS  -r n 
#PBS  -j oe 
#PBS  -V 
#PBS -l nodes=2:ppn=1
...
# cd to case
cd /nics/c/home/ywang254/models/E3SM/cime/scripts/20220209_US-SPR_ICB1850CNRDCTCBC_ad_spinup
...
cd $(./xmlquery RUNDIR --value)
   /lustre/haven/user/ywang254/E3SM/output/20220209_US-SPR_ICB1850CNRDCTCBC_ad_spinup/bld/e3sm.exe   >> e3sm.log.$LID 2>&1 

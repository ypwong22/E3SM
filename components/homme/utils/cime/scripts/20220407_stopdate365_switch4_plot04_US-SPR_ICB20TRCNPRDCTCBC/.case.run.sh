...
#PBS  -N run.20220407_stopdate365_switch4_plot04_US-SPR_ICB20TRCNPRDCTCBC
#PBS  -r n 
#PBS  -j oe 
#PBS  -V 
#PBS -l nodes=2:ppn=1
...
# cd to case
cd /nics/c/home/ywang254/models/E3SM/cime/scripts/20220407_stopdate365_switch4_plot04_US-SPR_ICB20TRCNPRDCTCBC

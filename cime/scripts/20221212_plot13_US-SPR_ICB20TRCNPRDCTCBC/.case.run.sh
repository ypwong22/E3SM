...
#SBATCH  --job-name=run.20221212_plot13_US-SPR_ICB20TRCNPRDCTCBC
#SBATCH  --nodes=1
#SBATCH  --output=run.20221212_plot13_US-SPR_ICB20TRCNPRDCTCBC.%j 
#SBATCH  --exclusive 
...
# cd to case
cd /home/ywo/models/E3SM/cime/scripts/20221212_plot13_US-SPR_ICB20TRCNPRDCTCBC

...
#SBATCH  --job-name=run.UQ_default2_1_optimized_US-SPR_ICB1850CNPRDCTCBC
#SBATCH  --nodes=1
#SBATCH  --output=run.UQ_default2_1_optimized_US-SPR_ICB1850CNPRDCTCBC.%j 
#SBATCH  --exclusive 
...
# cd to case
cd /home/ywo/models/E3SM/cime/scripts/UQ_default2_1_optimized_US-SPR_ICB1850CNPRDCTCBC

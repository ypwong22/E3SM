...
#PBS  -N run.20211119_ambient_US-SPR_ICB20TRCNPRDCTCBC
#PBS  -r n 
#PBS  -j oe 
#PBS  -V 
#PBS -l nodes=2:ppn=1
...
# cd to case
cd /nics/c/home/ywang254/models/E3SM/cime/scripts/20211119_ambient_US-SPR_ICB20TRCNPRDCTCBC
...
cd $(./xmlquery RUNDIR --value)
   /lustre/haven/user/ywang254/E3SM/output/20211119_ambient_US-SPR_ICB20TRCNPRDCTCBC/bld/e3sm.exe   >> e3sm.log.$LID 2>&1 

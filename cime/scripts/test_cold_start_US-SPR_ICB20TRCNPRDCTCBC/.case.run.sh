...
#SBATCH  --job-name=run.test_cold_start_US-SPR_ICB20TRCNPRDCTCBC
#SBATCH  --nodes=1
#SBATCH  --output=run.test_cold_start_US-SPR_ICB20TRCNPRDCTCBC.%j 
#SBATCH  --exclusive 
...
# cd to case
cd /home/ywo/models/E3SM/cime/scripts/test_cold_start_US-SPR_ICB20TRCNPRDCTCBC

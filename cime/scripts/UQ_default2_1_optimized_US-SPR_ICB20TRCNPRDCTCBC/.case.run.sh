...
#SBATCH  --job-name=run.UQ_default2_1_optimized_US-SPR_ICB20TRCNPRDCTCBC
#SBATCH  --nodes=1
#SBATCH  --output=run.UQ_default2_1_optimized_US-SPR_ICB20TRCNPRDCTCBC.%j 
#SBATCH  --exclusive 
...
# cd to case
cd /home/ywo/models/E3SM/cime/scripts/UQ_default2_1_optimized_US-SPR_ICB20TRCNPRDCTCBC

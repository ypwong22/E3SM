...
#SBATCH  --job-name=run.20230212_plot17_US-SPR_ICB20TRCNPRDCTCBC
#SBATCH  --nodes=1
#SBATCH  --output=run.20230212_plot17_US-SPR_ICB20TRCNPRDCTCBC.%j 
#SBATCH  --exclusive 
...
# cd to case
cd /home/ywo/models/E3SM/cime/scripts/20230212_plot17_US-SPR_ICB20TRCNPRDCTCBC

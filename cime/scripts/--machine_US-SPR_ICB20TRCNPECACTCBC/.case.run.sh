...
#SBATCH  --job-name=run.--machine_US-SPR_ICB20TRCNPECACTCBC
#SBATCH  --nodes=1
#SBATCH  --output=run.--machine_US-SPR_ICB20TRCNPECACTCBC.%j 
#SBATCH  --exclusive 
...
# cd to case
cd /home/ywo/models/E3SM/cime/scripts/--machine_US-SPR_ICB20TRCNPECACTCBC
...
cd $(./xmlquery RUNDIR --value)
   /lustre/or-scratch/cades-ccsi/scratch/ywo/E3SM/output/--machine_US-SPR_ICB20TRCNPECACTCBC/bld/e3sm.exe   >> e3sm.log.$LID 2>&1 

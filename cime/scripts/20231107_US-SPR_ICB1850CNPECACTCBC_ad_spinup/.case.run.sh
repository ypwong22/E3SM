...
#SBATCH  --job-name=run.20231107_US-SPR_ICB1850CNPECACTCBC_ad_spinup
#SBATCH  --nodes=1
#SBATCH  --output=run.20231107_US-SPR_ICB1850CNPECACTCBC_ad_spinup.%j 
#SBATCH  --exclusive 
...
# cd to case
cd /home/ywo/models/E3SM/cime/scripts/20231107_US-SPR_ICB1850CNPECACTCBC_ad_spinup
...
cd $(./xmlquery RUNDIR --value)
   /home/ywo/20231107_US-SPR_ICB1850CNPECACTCBC_ad_spinup/bld/e3sm.exe   >> e3sm.log.$LID 2>&1 

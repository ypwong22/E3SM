...
#SBATCH  --job-name=run.20231112_US-SPR_ICB20TRCNPECACTCBC
#SBATCH  --nodes=1
#SBATCH  --output=run.20231112_US-SPR_ICB20TRCNPECACTCBC.%j 
#SBATCH  --exclusive 
...
# cd to case
cd /home/ywo/models/E3SM/cime/scripts/20231112_US-SPR_ICB20TRCNPECACTCBC

...
#PBS  -N run.20220407_stopdate365_switch4_US-SPR_ICB1850CNPRDCTCBC
#PBS  -r n 
#PBS  -j oe 
#PBS  -V 
#PBS -l nodes=2:ppn=1
...
# cd to case
cd /nics/c/home/ywang254/models/E3SM/cime/scripts/20220407_stopdate365_switch4_US-SPR_ICB1850CNPRDCTCBC

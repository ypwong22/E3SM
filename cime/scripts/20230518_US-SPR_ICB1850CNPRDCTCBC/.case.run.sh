...
#SBATCH  --job-name=run.20230518_US-SPR_ICB1850CNPRDCTCBC
#SBATCH  --nodes=1
#SBATCH  --output=run.20230518_US-SPR_ICB1850CNPRDCTCBC.%j 
#SBATCH  --exclusive 
...
# cd to case
cd /home/ywo/models/E3SM/cime/scripts/20230518_US-SPR_ICB1850CNPRDCTCBC

...
#SBATCH  --job-name=run.test_restart_US-SPR_ICB1850CNPRDCTCBC
#SBATCH  --nodes=1
#SBATCH  --output=run.test_restart_US-SPR_ICB1850CNPRDCTCBC.%j 
#SBATCH  --exclusive 
...
# cd to case
cd /home/ywo/models/E3SM/cime/scripts/test_restart_US-SPR_ICB1850CNPRDCTCBC
...
cd $(./xmlquery RUNDIR --value)
   /lustre/or-scratch/cades-ccsi/scratch/ywo/E3SM/output/test_restart_US-SPR_ICB1850CNPRDCTCBC/bld/e3sm.exe   >> e3sm.log.$LID 2>&1 

...
#SBATCH  --job-name=run.20230101_plot07_US-SPR_ICB20TRCNPRDCTCBC
#SBATCH  --nodes=1
#SBATCH  --output=run.20230101_plot07_US-SPR_ICB20TRCNPRDCTCBC.%j 
#SBATCH  --exclusive 
...
# cd to case
cd /home/ywo/models/E3SM/cime/scripts/20230101_plot07_US-SPR_ICB20TRCNPRDCTCBC

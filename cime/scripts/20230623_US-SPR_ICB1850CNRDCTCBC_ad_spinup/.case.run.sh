...
#SBATCH  --job-name=run.20230623_US-SPR_ICB1850CNRDCTCBC_ad_spinup
#SBATCH  --nodes=1
#SBATCH  --output=run.20230623_US-SPR_ICB1850CNRDCTCBC_ad_spinup.%j 
#SBATCH  --exclusive 
...
# cd to case
cd /home/ywo/models/E3SM/cime/scripts/20230623_US-SPR_ICB1850CNRDCTCBC_ad_spinup
...
cd $(./xmlquery RUNDIR --value)
   /lustre/or-scratch/cades-ccsi/scratch/ywo/E3SM/output/20230623_US-SPR_ICB1850CNRDCTCBC_ad_spinup/bld/e3sm.exe   >> e3sm.log.$LID 2>&1 
